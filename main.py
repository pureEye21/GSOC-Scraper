...
for organisation in organisations1:
    ...
    for child in child_windows:
        ...
        if parent_window1!=child:
            ...
            Technologies.append(data1.text)
            Topics.append(data2.text)
            Brief_Description.append(data3.text)
            Links.append(data4.text)
...
File = pd.DataFrame({'Description': Brief_Description, 'TechStack': Technologies, 'Topics': Topics, 'Link': Links})
